...
/// Central source of truth for all Sellora POS typography defined in `design.md`.
/// Built around the Sora geometric sans-serif typeface.
class AppTextStyles {
  AppTextStyles._();
  ...
  /// Constructs the complete Material 3 TextTheme mapped precisely from `design.md`.
  static TextTheme createTextTheme() {
    return TextTheme(
      // Display styles
      displayLarge: displayLarge,
      displayMedium: displayMedium,
      displaySmall: tabularBig,
